...
class InteractiveMenu:
    ...
    def view_content_details(self, content_id: int) -> None:
        """Display detailed information about a specific content item including description, tags, and dates."""
        try:
    ...
    def view_saved_content(self) -> None:
            ...
            try:
                while True:
                    ...
                    display_list.sort(key=lambda x: x.added_at or datetime.datetime.min, reverse=True)
