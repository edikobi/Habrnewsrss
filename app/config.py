...
class Settings(BaseSettings):
    ...
    smtp_port: int = 587
    smtp_username: str = ""  # example: "your-email@gmail.com"
    smtp_password: str = ""  # example: "your-app-password"
    smtp_from_email: str = ""  # example: "your-email@gmail.com"
    smtp_use_tls: bool = True
    # Для использования Gmail необходимо создать пароль приложения:
    # https://support.google.com/accounts/answer/185833
    # Для других SMTP провайдеров укажите соответствующие host и port
    ...
    class Config:
            ...
            Note: Users should copy '.env.example' to '.env' in the project root 
            and fill in their specific values. SMTP configuration is required 
            for email digest functionality.
            """
            env_file = ".env"
            extra = "ignore"
